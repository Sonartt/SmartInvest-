...
## Reconciled Premium Access Feature Matrix

This section reconciles premium access features across the system to ensure nothing from earlier discussions is lost.
...
- **Auto-grant on payment**: M-Pesa, PayPal, and KCB flows grant 30-day premium on success.
- **Manual grant/revoke**: Admin endpoints grant or revoke premium with audit metadata.
- **Audit trail**: `premiumGrantedBy`, `premiumReason`, and timestamps stored per user.

### Premium Feature Coverage
- **Academy**: Course listings and content gated.
- **Tools**: Portfolio tracker, risk profiler, AI recommendations gated.
- **Scenarios**: Calculator scenarios list/save/read gated.
- **Calculators**: Premium calculators remain locked until premium status is active.

### Notifications & Compliance
- **Welcome emails**: Signup and premium activation send terms and content access details.
- **Payment confirmations**: Successful payments notify user and confirm premium activation.
- **Security notices**: Password resets include recent activity logs for fraud detection.
