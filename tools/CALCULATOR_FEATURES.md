...
## 🆕 ADDITIONAL CALCULATIONS TO ADD

### Options & Derivatives
- **Black-Scholes Option Pricing** ✅ (in calculator_functions.js)
...
- **Mortgage Calculations**
  - Loan affordability analysis ✅ (in calculator_functions.js)
...
### Tax Planning
- **Income Tax Calculations** ✅ (in calculator_functions.js)
...
### Asset Valuation
- **Depreciation Methods** ✅ (in calculator_functions.js)
  - Straight-line
  - Declining balance
  - Sum-of-years-digits
...
### Portfolio Theory
- **Portfolio Optimization** ✅ (in calculator_functions.js - basic version)
...
## 📊 CALCULATION CATEGORIES SUMMARY

| Category | Implemented | To Add | Priority |
|----------|-------------|--------|----------|
| Investment | ✅ Full | Monte Carlo | Medium |
| Loans/Credit | ✅ Full | Affordability+ | High |
| Insurance | ✅ Full | Multi-life | Medium |
| Bonds | ✅ Full | Convertibles | Low |
| Retirement | ✅ Full | Social Security | High |
| Actuarial | ✅ Good | Life Tables | Medium |
| Risk/Portfolio | ✅ Good | Optimization | High |
| Business | ✅ Good | DCF/Valuation | High |
| Auditing | ✅ Good | Sampling+ | Medium |
| Options | ⚠️ Basic | Full Greeks | High |
| Real Estate | ❌ None | Full Suite | High |
| Taxes | ⚠️ Basic | State/Capital | High |
| Crypto | ❌ None | Basic Set | Medium |
| FX/International | ❌ None | Basic Set | Low |
...
- ✅ Formula displays with KaTeX
- ✅ Step-by-step explanations
- ✅ Info boxes with context
- ✅ Warning boxes for edge cases
